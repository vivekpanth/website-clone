    ...
    <div className="grid grid-flow-col shadow-md font-sans text-lg">
      <div className="h-16 p-2  col-span-3 flex ">
        <img
          ...
          className=" h-full p-2 cursor-pointer hover:bg-gray-200 "
        ...
        <a href="/">
          <img
            ...
            src="https://png.pngtree.com/png-clipart/20221019/original/pngtree-youtube-social-media-round-icon-png-image_8704829.png"
            alt="menu logo"
          />
        </a>
        <a href="/">
          <img
            className="h-full  p-2 cursor-pointer hidden md:block "
      ...
      <div className="col-span-6 p-1 flex items-center justify-center m-1">
        <input
          type="text "
          className="w-1/4 h-3/4 text-base p-2 md:w-full px-4 border border-gray-400 rounded-l-full"
          placeholder=" Search"
          value={searchQuery}
          onChange={(e)=>setsearchQuery(e.target.value)}
        ></input>
        <span className=" rounded-r-full border-2 border-gray-400 h-3/4 p-2 items-center hover:bg-gray-200">
          <BiSearchAlt2 />
        </span>
      </div>
      <div className="h-16 py-2 px-2  md:px-10 col-span-3 flex items-center justify-end ">
        <img
          className=" h-full py-2 px-4 cursor-pointer "
